  ...
  return (
    <main className="flex flex-col items-center overflow-hidden">
      ...
      <section className="relative w-full flex flex-col items-center px-6 pt-24 pb-20 overflow-hidden">
        {/* Floating music notes - Matcha-style scattered elements */}
        {[
          { symbol: "𝄞", ...floatingNote("8%", "12%", 0, -20, 72) },
          { symbol: "♪", ...floatingNote("85%", "18%", 0.5, 15, 56) },
          { symbol: "♫", ...floatingNote("15%", "65%", 1.2, -10, 48) },
          { symbol: "♬", ...floatingNote("78%", "70%", 0.8, 25, 52) },
          { symbol: "♩", ...floatingNote("42%", "8%", 1.5, -30, 40) },
          { symbol: "♪", ...floatingNote("92%", "45%", 0.3, 20, 44) },
          { symbol: "𝄢", ...floatingNote("5%", "40%", 2, 12, 60) },
          { symbol: "♫", ...floatingNote("55%", "80%", 1.8, -18, 46) },
        ].map(({ symbol, ...props }, i) => (
          <motion.span key={i} {...props}>
            <span className="font-display font-bold bg-gradient-to-br from-[#6c5ce7]/30 to-[#00b894]/20 bg-clip-text text-transparent">
              {symbol}
            </span>
          </motion.span>
        ))}
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl" variants={staggerContainer}>
          {[
            ...
            <motion.div
              ...
              className="group rounded-2xl border border-border p-8 hover:shadow-lg transition-shadow"
              style={{ background: "var(--gradient-card)" }}
            >
      ...
      >
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl" variants={staggerContainer}>
          {[
        ...
        <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-3xl" variants={staggerContainer}>
          {[
            ...
            <motion.div
              ...
              className="flex flex-col items-center gap-3 p-6 rounded-2xl border border-border hover:shadow-lg transition-shadow"
              style={{ background: "var(--gradient-card)" }}
            >
